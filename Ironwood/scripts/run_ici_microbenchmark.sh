...
CONFIG_NAMES="all_gather_1d  all_reduce_1d all_to_all_1d "

CONFIG_NAMES="all_gather_3d all_reduce_3d all_to_all_3d all_gather_2d all_reduce_2d all_to_all_2d all_gather_1d all_reduce_1d all_to_all_1d"
