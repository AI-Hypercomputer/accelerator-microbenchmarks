...
COMPUTE_BENCHMARK_MAP = {
    ...
    "gemm_reducescatter_allgather": "benchmark_gemm_all_reduce.gemm_reducescatter_allgather",
    "gemm_only": "benchmark_gemm_all_reduce.gemm_only",
    "all_reduce_only": "benchmark_gemm_all_reduce.all_reduce_only",
    "gemm_sharded_all_gather": "benchmark_gemm_all_reduce.gemm_sharded_all_gather",
    "gemm_k_sharded_all_reduce": "benchmark_gemm_all_reduce.gemm_k_sharded_all_reduce",
